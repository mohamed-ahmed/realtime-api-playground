...
function createRealTimeFile(){
	rtclient.createRealtimeFile("test", null, function(file){
		console.log(file);
	    gapi.drive.realtime.load(file.id, fileLoaded, initModel, null);
	});
	...
	var initModel = function(model){
		var string = model.createString("my test model");
		console.log("hello ");
		console.log(string);
